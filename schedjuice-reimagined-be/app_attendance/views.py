...
from app_attendance.cancel_checkin import cancel_open_checkin, resolve_cancel_checkin_source
    ...
    def post(self, request: Request, course_id: int):
        ...
        try:
            updated = cancel_open_checkin(
                ...
                note=data.get("note"),
                source=resolve_cancel_checkin_source(request),
            )
        except PermissionDenied as exc:
            return self.forbidden(str(exc))
