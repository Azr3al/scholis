...
class QuizV3RBACTests(TestCase):
    ...
    def test_student_forbidden_on_quiz_author_list(self):
        with self.settings(RBAC_ENFORCE="enforce"):
            resp = self._client(self.student).get("/api/v1/quizzes?page=1&size=24")
        self.assertEqual(resp.status_code, 403)

    def test_student_forbidden_on_quiz_attempts_list(self):
        with self.settings(RBAC_ENFORCE="enforce"):
