    ...
    def setUp(self):
        ...
        with schema_context(self.schema_name):
            ...
            self.student = User.objects.create_user(
                email=f"stu-rss-{suffix}@example.com",
                password="x",
                name="Student",
                phone_number="-",
            ...
            rss = ReceiverSideScreenshot.objects.create(
                transaction_id=self.transaction_id,
                is_matched=False,
                user_payment=None,
            )
