...
| Property | Value |
| --- | --- |
| Who can edit | Superadmin/admin for create/link Team; superadmin/admin or course teacher (on roster or creator) for announcement channel when Team is linked |
