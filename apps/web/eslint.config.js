...
export default [
  {
<<<<<<< HEAD
    // Next.js generates and rewrites this on every build; it is not ours to lint.
          ...
          patterns: [
            {
              ...
              message:
<<<<<<< HEAD
                'The take flow must never reach answer keys or the database. Go through an API route (IMPLEMENTATION.md §3).',
=======
